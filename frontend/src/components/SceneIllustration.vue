...
<template>
  ...
  >
    ...
    <!-- 远处的城墙轮廓 -->
    <path
      d="M0 180 L100 175 L150 160 L200 165 L280 155 L320 158 L400 150 L480 155 L520 160 L600 152 L680 158 L720 165 L800 160 L800 200 L0 200 Z"
      fill="#5c4a3a"
      opacity="0.6"
    />
    ...
    <g filter="url(#glow)">
      ...
      <!-- 灯笼上的字 -->
      <text x="400" y="235" text-anchor="middle" fill="#ffd700" font-size="8" font-family="serif">
        拾忆
      </text>
    </g>
  ...
  >
    ...
    <g>
      ...
      >
        <animate
          attributeName="d"
          values="M442 298 Q444 292 441 286;M442 298 Q440 290 443 284;M442 298 Q444 292 441 286"
          dur="3s"
  ...
  >
    ...
    <g>
      ...
      <!-- 大脑轮廓 -->
      <path
        d="M360 200 Q370 160 400 155 Q430 160 440 200 Q445 230 420 245 Q400 250 380 245 Q355 230 360 200"
        fill="none"
        stroke="#7c4dff"
        stroke-width="1.5"
        opacity="0.6"
    ...
    <g>
      ...
      <path
        d="M330 380 Q330 350 360 340 L440 340 Q470 350 470 380"
        fill="#2a3a5e"
        stroke="#3a5a8e"
        stroke-width="1"
      />
    ...
    <g>
      ...
      <!-- 标签 -->
      <text x="580" y="330" text-anchor="middle" fill="#4fc3f7" font-size="6" opacity="0.4">
        记忆存储舱
      </text>
    </g>
  ...
  >
    ...
    <g fill="#3a3a4e" opacity="0.5">
      <ellipse cx="300" cy="395" rx="6" ry="10" />
      <rect x="296" y="405" width="8" height="15" rx="2" />
      <ellipse cx="350" cy="400" rx="5" ry="9" />
      <rect x="347" y="409" width="7" height="14" rx="2" />
      <ellipse cx="420" cy="392" rx="6" ry="10" />
      <rect x="416" y="402" width="8" height="16" rx="2" />
      <ellipse cx="480" cy="398" rx="5" ry="9" />
      <rect x="477" y="407" width="7" height="14" rx="2" />
      <ellipse cx="530" cy="395" rx="6" ry="10" />
      <rect x="526" y="405" width="8" height="15" rx="2" />
    </g>
    <!-- 行李 -->
  ...
  >
    ...
    <text x="400" y="250" text-anchor="middle" fill="#4fc3f7" font-size="24" opacity="0.3">
      记忆碎片...
    </text>
  </svg>
</template>
