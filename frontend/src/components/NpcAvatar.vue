...
<template>
  <div
    ...
    role="img"
    :aria-label="t('a11y.npc')"
  >
    <!-- 青年陈守义: 黑发、朝气、方脸 -->
    <svg
      v-if="npcId === 'chen_shouyi_young'"
      viewBox="0 0 100 100"
    ...
    >
      ...
      <!-- 头发 -->
      <path
        d="M28 38 Q35 18 50 16 Q65 18 72 38 L70 32 Q60 20 50 18 Q40 20 30 32 Z"
        fill="#1a0a00"
      />
    ...
    <!-- 老年陈守义: 白发、皱纹、沧桑 -->
    <svg
      v-else-if="npcId === 'chen_shouyi_old'"
      viewBox="0 0 100 100"
      xmlns="http://www.w3.org/2000/svg"
    >
      <circle cx="50" cy="50" r="48" fill="#1a1a2e" />
      ...
      <!-- 白发 -->
      <path
        d="M28 38 Q35 16 50 14 Q65 16 72 38 L70 30 Q58 18 50 16 Q42 18 30 30 Z"
        fill="#aaaaaa"
      />
      <!-- 皱纹 -->
    ...
    <svg v-else-if="npcId === 'xiaoyu'" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
      ...
      <!-- 长发 -->
      <path
        d="M26 35 Q30 12 50 10 Q70 12 74 35 L74 65 Q70 75 65 70 L65 40 Q60 20 50 18 Q40 20 35 40 L35 70 Q30 75 26 65 Z"
        fill="#1a0a00"
      />
      <!-- 脸 -->
